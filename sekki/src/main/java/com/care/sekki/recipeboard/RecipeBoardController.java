...
public class RecipeBoardController {
	@Autowired
	private RecipeBoardService recipeservice;
	@Autowired
	private HttpSession session;

	@RequestMapping("/recipeboardForm")
	public String recipeboardForm(@RequestParam(value = "currentPage", required = false) String cp, Model model) {
	...
	public String recipeboardContent(@RequestParam(value = "no", required = false) String n, Model model) {
	...
	public void recipeboardDownload(@RequestParam(value = "no", required = false) String n, HttpServletResponse res)
			throws IOException {
	...
	public String recipeboardModify(@RequestParam(value = "no", required = false) String n, Model model) {
