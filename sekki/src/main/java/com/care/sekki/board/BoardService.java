...
public class BoardService {
	...
	public void boardFriendForm(String cp, String search, Model model) {
			...
			ArrayList<BoardDTO> boards = boardMapper.boardFriendForm(begin, end, search);
			int totalCount = boardMapper.count(search);
			String url = "boardFriendForm?&search="+search+"currentPage=";
			String result = PageService.printPage(url, currentPage, totalCount, pageBlock);
