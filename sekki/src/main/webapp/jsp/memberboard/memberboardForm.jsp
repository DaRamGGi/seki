			...
			<table border=1>
				...
				<c:forEach var="memberboard" items="${memberboards}">
					<tr>
						...
						<td
							onclick="location.href='memberboardContent?no=${memberboard.no}'">
							${memberboard.title}</td>
				...
				<tr>
					...
					<td colspan="10">${result}</td>
					<td><button type="button"
							onclick="location.href='memberboardWrite'">글쓰기</button></td>
				</tr>
			</table>
		</c:otherwise>
	</c:choose>
