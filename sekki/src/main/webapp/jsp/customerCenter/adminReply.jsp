		...
		<form action="adminReplyProc?num=${inquiry.num}" method='post' id="f">
			<div>
				<table class="adminReplyTable">
					...
					<tr>
						<th>답변 작성<label id="contentLabel" class="contentLabel">
								(*필수)</label></th>
					</tr>
					<tr>
						<td><textarea rows="10" cols="30" name="replyContent"
								id="replyContent" maxlength="1000" oninput="replyContentCheck()"
			...
			<div class="writeReplybtnDiv">
				<input type="submit" value="답변하기"> <input type="button"
