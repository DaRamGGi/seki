...
<div align="center" class="sub_div">
	...
	<table >
		<tr>
			...
			<form action="updateProc" method="post" id="f">
				...
				<input type="button" value="회원수정" onclick="validateAndSubmit()" class="btn">
	...
	<div class="MAPS" >
      <div style="display: flex; flex-direction: column; align-items: center;">
        ...
        <div id="map" style="width: 500px; height: 300px; margin-right:20px; margin-top:20px;"></div>
